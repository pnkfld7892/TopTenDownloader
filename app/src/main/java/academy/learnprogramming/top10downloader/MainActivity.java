...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(!String.format(feedUrl,feedLimit).equals(lastUrl))
            downloadUrl(String.format(feedUrl, feedLimit));
        return true;
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if(!lastUrl.equals("") || lastUrl != null){
...
//                    MainActivity.this,R.layout.list_item,parseApplications.getApplications());
        ...
        //recommended to use buffered reader for inputstreams
        @Nullable
...
//                simplified version of above
                ...
                //buffered reader calls close method of inner readers which closes its own connection
                reader.close();
